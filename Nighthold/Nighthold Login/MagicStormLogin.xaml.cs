...
using MagicStorm_Login.Nighthold;
...
{
    /// <summary>
    /// Interaction logic for MagicStormLogin.xaml
    /// </summary>
    public partial class MagicStormLogin : Window
    {
        public static bool LoggedOut;

        public MagicStormLogin()
        {
        ...
        private async void AttemptToLogin()
        {
            ...
            try
            {
                ...
                if (loginResponse != null)
                {
                    ...
                    {
                        Process.Start($"MagicStorm Launcher.exe", $"\"{ LoginUsernameBox.Text }\" \"{ LoginPasswordBox.Password }\""); // vot tut padaet teper
